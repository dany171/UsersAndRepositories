...
describe('RepositoryListComponent', () => {
  ...
  let repositoriesServiceStub = new RepositoriesServiceStub()
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers:[{ provide: RepositoryDataService, useValue: repositoriesServiceStub },
                {provide: UserDataService, userValue: userServiceStub},
                { provide: ActivatedRoute, useValue: { 'params': observer} },
                 { provide: Router, userValue: mockRouter}, Location, LocationStrategy
                ]
    })
    .compileComponents();
  }));
